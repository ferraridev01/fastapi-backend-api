...
def test_update_product_without_admin(
    client,
    created_product,
    updated_product_data,
    auth_headers,
...
def test_delete_product_authenticated(client, created_product, admin_auth_headers):
    product_id = created_product["id"]
...
def test_delete_product_without_admin(client, created_product, auth_headers):
    product_id = created_product["id"]
